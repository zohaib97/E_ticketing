...
<head>
  ...
  <title>E-Ticket | View Passenger</title>
 <!-- General CSS Files -->
...
<!-- end header -->
       ...
       <a href="edit_passenger.php?eid=<?php echo $rows["id"]?>">  <p title="Edit" class="fa fa-edit" style="color: black"></p></a>
      <!-- </a> -->
				&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="viewpassenger.php?did=<?php echo $rows["id"]?>"> <p title="Delete" class="fa fa-times-circle" style="color: black"></p></a>
