...
if(isset($_POST["sub"]))
{
    ...
    $adr=$_POST["adr"];
        ...
        $query=mysqli_query($con,"UPDATE `users` SET `lname`='$lname',`fname`='$fname',`email`='$email',`pass`='$pass',`role`='$role',`Contact`='$cnt',`address`='$adr' WHERE id='$id'");
	
	if($query)
	{
        // header("location:login.php");
        echo "<script>   alert ('Data Updated Successfully')</script>";
       echo "<script>window.open('viewpassenger.php','_self')</script>";
