...
if(isset($_POST["sub"]))
{
    ...
    $role=$_POST['role'];
        ...
        if($query)
        {
           ...
           echo "<script>window.open('userview.php','_self')</script>";
        ...
        <section class="section">
          ...
          <form id="validateForm" method="post" >
                  ...
                  <input type="hidden" value="<?=$row['id']?>" name="id">
                    <div class="form-group col-6">
                      <label for="frist_name">First Name</label>
                      <input id="frist_name" type="text" class="form-control" name="fname" value="<?=$row['fname']?>" autofocus>
                    </div>
                    <div class="form-group col-6">
                      <label for="last_name">Last Name</label>
          ...
          if($rows['role'] == 'user' || $rows['role'] == 'admin' &&  $rows['rid'] == $row['role']) { ?>
					...
					<?php
                        ...
                        elseif($rows['role'] == 'user' || $rows['role'] == 'admin') { ?>
