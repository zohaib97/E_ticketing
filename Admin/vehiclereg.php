...
//    $num_row=mysqli_num_rows($query1);
    ...
    else
    {
        ...
        $query=mysqli_query($con,"insert into vehicle(name,v_no,v_img) values('$vname','$vno','$vimg')");
        
        if($query)
        {
            // header("location:login.php");
            echo "<script>   alert ('Data Insert Successfully')</script>";
           echo "<script>window.open('vehiclereg.php','_self')</script>";
          ...
          <form id="validateForm" method="post" enctype="multipart/form-data" >
                  <div class="row">
                    <div class="form-group col-6">
                      ...
                      <input id="vname" type="text" class="form-control" name="vname" autofocus>
                    </div>
                    <div class="form-group col-6">
                      <label for="vno">Vehicle No</label>
                      <input id="vno" type="text" class="form-control" name="vno">
                    </div>
                  </div>
